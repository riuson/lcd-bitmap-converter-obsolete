...
namespace lcd_bitmap_converter_mono
{
    ...
    {
        private UnicodeRange[] mRanges;

        public UnicodeHelper()
        {
            //http://www.orwell.ru/test/Unicode/
            this.mRanges = new UnicodeRange[]{
                new UnicodeRange("C0 Controls and Basic Latin", 0x0000, 0x007F),
                new UnicodeRange("C1 Controls and Latin-1 Supplement", 0x0080, 0x00FF),
                ...
                new UnicodeRange("Variation Selectors Supplement", 0xE0100, 0xE01EF),
                new UnicodeRange("Supplementary Private Use Area-A", 0xF0000, 0xFFFFF),
                new UnicodeRange("Supplementary Private Use Area-B", 0x100000, 0x10FFFD)
            };
        }

        public UnicodeRange[] Ranges
        {
            get { return this.mRanges; }
        }
    }
    ...
    public class UnicodeRange : Object
    {
        ...
        {
            get { return this.mCodeStart; }
        }
        public int CodeEnd
        {
            get { return this.mCodeEnd; }
        }
        public string Name
        {
        ...
        {
            return String.Format("{0} [{1:X}...{2:X}]", this.mName, this.mCodeStart, this.mCodeEnd);
        }
    }
}
